...
class Taxon(models.Model):
    ...
    # The important thing here is for the Rank values to order from general to
    # specific. Mnemonicity is nice, but not necessary.
    MAIN_RANKS = (
        ('E', 'order'),
        ('L', 'family'),
        ('P', 'genus'),
    ...
    def __unicode__(self):
        if self.rank == 'Sl': 
            genus = self
            while genus.rank != 'Pl' and genus.supertaxon is not None:
